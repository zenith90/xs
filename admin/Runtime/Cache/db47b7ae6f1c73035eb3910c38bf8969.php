							...
							<div class="widget-content">
								<table class="table table-hover">
									...
									<?php if(is_array($users)): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr>
											...
											<td> <a class="btn btn-small  btn-primary"  href="__URL__/edit/id/<?php echo ($user["id"]); ?>">修改</a> 
											<a class="btn btn-mini   btn-primary"  href="__URL__/del/id/<?php echo ($user["id"]); ?>" onclick="return confirm('确定要删除用户<?php echo ($user["username"]); ?>吗？')">删除</a> </td>

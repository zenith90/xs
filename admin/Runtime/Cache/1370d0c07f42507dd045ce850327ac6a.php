			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					<div class="btn-toolbar">
						<a class="btn btn-inverse btn btn-large btn-primary" href="__APP__/Cls/add">添加分类</a>
						<a class="btn btn-cm btn btn-large btn-primary" href="__APP__/Cls/index">所有分类</a>
					</div>
				</ul>
						...
						<div class="well widget">
							...
							<div class="widget-content">
								<table class="table table-hover">
									...
									<tbody>
									<?php if(is_array($noveclass)): $i = 0; $__LIST__ = $noveclass;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$novel): $mod = ($i % 2 );++$i;?><tr>
											<td><?php echo ($novel["id"]); ?></td>
											<td><?php echo ($novel["classname"]); ?></td>
											<td><?php echo ($novel["classpy"]); ?></td>
											<td> <a class="btn btn-small  btn-primary"  href="__URL__/edit/id/<?php echo ($novel["id"]); ?>">修改</a> 
											<a class="btn btn-mini   btn-primary"  href="__URL__/del/id/<?php echo ($novel["id"]); ?>"  onclick="return confirm('确定要删除小说分类<?php echo ($novel["classname"]); ?>吗？')">删除</a> </td>

				...
				<div class="row-fluid">
					...
					<div class="well widget">
							<div class="widget-header">
								<h3 class="title">修改小说 "<?php echo ($novelinfo["novelname"]); ?>" 的内容</h3>
							</div><!--enctype="multipart/form-data" -->
							<form class="form-horizontal" action="" method="POST"/>
								<div class="control-group">
									<label class="control-label" for="inputEmail">内容标题</label>
									<div class="controls">
										<input class="input-xxlarge" type="text" id="con_name" name="con_name" placeholder="请输入标题" value="<?php echo ($conInfo["con_name"]); ?>"/>
									</div>
								</div>
								
								<div class="control-group">
									<label class="control-label" for="inputEmail">内容拼音化</label>
									<div class="controls">
										<input type="text" class="input-xxlarge" id="con_namepy" name="con_namepy" placeholder="为空自动拼音化" value="<?php echo ($conInfo["con_namepy"]); ?>"/>
									</div>
								</div>
								
								
								<div class="control-group">
									<label class="control-label" for="inputEmail">所属分卷</label>
									<div class="controls">
										<select class="span8" name="con_vid" id="con_vid">
										<?php if(is_array($volinfo)): $i = 0; $__LIST__ = $volinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value='<?php echo ($v["id"]); ?>' <?php if(($v["id"]) == $conInfo["con_vid"]): ?>selected="selected"<?php endif; ?> ><?php echo ($v["volname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
								...
								<div class="control-group">
									...
									<label class="checkbox inline">
										<input type="radio" id="novelstate" name="novelstate" value="0" class="fancy" <?php if($novelinfo["novelstate"] == 0): ?>checked="checked"<?php endif; ?>/> 连载中 
									</label>
									<label class="checkbox inline">
										<input type="radio" id="novelstate" name="novelstate" value="1" class="fancy" <?php if($novelinfo["novelstate"] == 1): ?>checked="checked"<?php endif; ?>/> 已完本
									</label>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea id="redactor_content" class="fullRedactor" name="con_text" style="scrollbar-arrow-color:yellow;scrollbar-base-color:lightsalmon,overflow:visible"><?php echo ($conInfo["con_text"]); ?></textarea>
									</div>
								</div>

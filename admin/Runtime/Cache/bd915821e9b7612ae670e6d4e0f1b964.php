							...
							<div class="widget-content">
								<table class="table table-hover">
									...
									<?php if(is_array($contents)): $i = 0; $__LIST__ = $contents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$content): $mod = ($i % 2 );++$i;?><tr>
											...
											<td> <a class="btn btn-small  btn-primary" href="__APP__/Chapter/edit/novelid/<?php echo ($content["con_nid"]); ?>/id/<?php echo ($content["id"]); ?>">修改</a>  
											<a class="btn btn-mini  btn-primary" href="__APP__/Chapter/del/novelid/<?php echo ($content["con_nid"]); ?>/id/<?php echo ($content["id"]); ?>" onclick="return confirm('确定要删除章节<?php echo ($content["con_name"]); ?>吗？')">删除</a> </td>

				...
				<div class="row-fluid">
					...
					<div class="well widget">
							<div class="widget-header">
								<h3 class="title">修改小说分类 "<?php echo ($classinfo["classname"]); ?>" 的信息</h3>
							</div>
							<form class="form-horizontal" name="editclass" action="" method="POST"/>
								<div class="control-group">
									<label class="control-label" for="inputEmail">分类名称</label>
									<div class="controls">
										<input type="text" class="input-xlarge" id="classname" name="classname" placeholder="为空则不修改" value="<?php echo ($classinfo["classname"]); ?>"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="inputPassword">分类拼音化</label>
									<div class="controls">
										<input type="text" class="input-xlarge" id="classpy" name="classpy" placeholder="为空则不修改"  value="<?php echo ($classinfo["classpy"]); ?>"/>
									</div>
								</div>

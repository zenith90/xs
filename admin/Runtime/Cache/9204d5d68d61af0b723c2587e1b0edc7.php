					...
					<div class="well widget">
							...
							<form class="form-horizontal" action="" method="POST">
								...
								<div class="control-group">
									<label class="control-label" for="inputEmail">顶部广告</label>
									<div class="controls">
										<textarea style="width:980px;height:212px;" placeholder="请输入顶部广告" id="top" name="top"><?php echo ($ads["top"]); ?></textarea>
									</div>
								</div>
								
								<div class="control-group">
									<label class="control-label" for="inputEmail">底部广告</label>
									<div class="controls">
										<textarea style="width:980px;height:212px;" placeholder="请输入底部广告" id="bottom" name="bottom"><?php echo ($ads["bottom"]); ?></textarea>
									</div>
								</div>

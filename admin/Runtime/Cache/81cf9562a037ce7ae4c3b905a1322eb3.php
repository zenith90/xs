					...
					<div class="span6">
						...
						<div class="well widget">
							...
							<div class="widget-header">
								<h3 class="title"><B><?php echo ($novelinfo["novelname"]); ?></B>搜索内容列表</h3>
							</div>
							<!-- ./ widget header -->
							...
							<div class="widget-content">
								<table class="table table-hover">
									...
									<?php if(is_array($contents)): $i = 0; $__LIST__ = $contents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$content): $mod = ($i % 2 );++$i;?><tr>
											...
											<td><?php echo ($content["novelname"]); ?></td>
											<td> <a class="btn btn-small  btn-primary" href="__URL__/edit/novelid/<?php echo ($content["con_nid"]); ?>/id/<?php echo ($content["id"]); ?>">修改</a>  
											<a class="btn btn-mini  btn-primary" href="__URL__/del/novelid/<?php echo ($content["con_nid"]); ?>/id/<?php echo ($content["id"]); ?>" onclick="return confirm('确定要删除章节<?php echo ($content["con_name"]); ?>吗？')">删除</a> </td>
		...
		function delMany(ParentID){
			if(confirm('确定要删除所选章节吗？')){
				...
				for(var i=0;i<span.length;i++){
					...
					window.location="__APP__/Chapter/delMore/id/"+get; 
				}
			}

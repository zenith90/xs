				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<div class="btn-toolbar">
						...
						<div class="btn-group dropdown-brownBg custom">
							...
							<ul class="dropdown-menu">
								<?php if(is_array($cls)): $i = 0; $__LIST__ = $cls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="__APP__/Novel/index/ordercls/<?php echo ($vo["id"]); ?>"><?php echo ($vo["classname"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
							</ul>
						</div>
						...
						<div class="well widget">
							...
							<div class="widget-content">
								<table class="table table-hover">
									...
									<tbody id="product">
									<?php if(is_array($novels)): $i = 0; $__LIST__ = $novels;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$novel): $mod = ($i % 2 );++$i;?><tr>
											<td><input type="checkbox" id="<?php echo ($novel["id"]); ?>" class="fancy" /><?php echo ($novel["id"]); ?></td>
											<td><?php echo ($novel["novelname"]); ?></td>
											<td><?php echo ($novel["classname"]); ?></td>
											<td><?php echo ($novel["novelauthor"]); ?></td>
											<td><?php echo (date('Y-m-d H:i:s',$novel["update_time"])); ?></td>
											<td><?php if($novel["novelstate"] == 0): ?>连载中<?php else: ?>已完本<?php endif; ?></td>
											
											<td>
											<a class="btn btn-small  btn-primary" href="__APP__/Vol/add/id/<?php echo ($novel["id"]); ?>">分卷</a>
											 <a class="btn btn-mini   btn-primary" href="__APP__/Chapter/add/id/<?php echo ($novel["id"]); ?>">内容</a>
											</td>
											
											<td><a class="btn btn-small  btn-primary"  href="__APP__/Vol/index/id/<?php echo ($novel["id"]); ?>">分卷</a> 
											 <a class="btn btn-mini   btn-primary"  href="__APP__/Chapter/index/id/<?php echo ($novel["id"]); ?>">内容</a>
											</td>
											
											<td> <a class="btn btn-small  btn-primary"  href="__URL__/edit/id/<?php echo ($novel["id"]); ?>">修改</a>  
											<a class="btn btn-mini   btn-primary"  href="__URL__/del/id/<?php echo ($novel["id"]); ?>" onclick="return confirm('确定要删除小说<?php echo ($novel["novelname"]); ?>吗？')">删除</a> 
											<a class="btn btn-mini btn-cm   btn-primary"  href="__URL__/tui/id/<?php echo ($novel["id"]); ?>">推荐</a> </td>

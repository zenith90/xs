					...
					<div class="span6">
						...
						<div class="well widget">
							...
							<div class="widget-header">
								<h3 class="title"><B><?php echo ($novelinfo["novelname"]); ?></B>分卷列表</h3>
							</div>
							<!-- ./ widget header -->
							...
							<div class="widget-content">
								<table class="table table-hover">
									...
									<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
											<td><?php echo ($v["id"]); ?></td>
											<td><?php echo ($v["volname"]); ?></td>
											<td><?php echo ($novelinfo["novelname"]); ?></td>
											<td> <a class="btn btn-small  btn-primary" href="__URL__/edit/id/<?php echo ($novelinfo["id"]); ?>/v/<?php echo ($v["id"]); ?>">修改</a>  
											<a  class="btn btn-mini  btn-primary" href="__URL__/del/id/<?php echo ($novelinfo["id"]); ?>/v/<?php echo ($v["id"]); ?>" onclick="return confirm('确定删除小说<?php echo ($novelinfo["novelname"]); ?>的分卷<?php echo ($v["volname"]); ?>吗？')">删除</a> </td>

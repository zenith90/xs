...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title><?php echo ($classinfo["classname"]); ?>排行榜_<?php echo ($classinfo["classname"]); ?>最新更新 - <?php echo ($siteinfo["site_name"]); ?></title>
	<meta name="keywords" content="<?php echo ($classinfo["classname"]); ?>">
		<meta name="description" content="<?php echo ($classinfo["classname"]); ?>是由<?php echo ($siteinfo["site_name"]); ?>提供，内容如有异议，请邮件说明！">
	...
	<DIV class="warpper">
		<DIV class="div_breadcrumbs">
			<H1 class="breadcrumbs">
				<DIV class="breadcrumbs"><?php echo ($classinfo["classname"]); ?></DIV>
			</H1>
		</DIV>
	</DIV>
